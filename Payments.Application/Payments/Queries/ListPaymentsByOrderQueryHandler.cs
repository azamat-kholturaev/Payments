...
public sealed class ListPaymentsByOrderQueryHandler(
    IReadRepository<Order> orders,
    IPaymentsWriteRepository payments,
    ICurrentUserProvider currentUser) : IRequestHandler<ListPaymentsByOrderQuery, IReadOnlyList<PaymentListItemDto>>
{
